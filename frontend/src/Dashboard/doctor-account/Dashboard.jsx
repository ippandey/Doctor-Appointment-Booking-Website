                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-10">
                      <figure className="max-w-[200px] max-h-[200px]">
                        <img src={data?.photo} alt="" className="w-full h-60" />
                      </figure>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-[6px]">
                          <span className="flex items-center gap-[6px] to-headingColor text-[14px] leading-5 lg:text-[16px] lg:leading-6 font-semibold">
