      ...
      <form>
        ...
        <div className="mb-5">
          ...
          {formData.timeSlots?.map((item, index) => (
            <div key={index}>
              <div>
                <div className="grid md:grid-cols-4 mb-[30px] grid-cols-2 gap-5">
                  <div>
          ...
          {formData.photo && (
            <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
              <img
                src={formData.photo}
                alt=""
                className="w-[60px] h-[55px] rounded-full"
              />
            </figure>
          )}
        ...
        <div className="mt-7">
          <button
            ...
            className="w-full bg-primaryColor text-white text-[18px] leading--[30px] py-3 px-4 rounded-lg"
          >
            Update Profile
          </button>
        </div>
